...
// Components
import FeesCategoryGuide from "./CategoryGuide/FeesCategoryGuide";
import FeesHeadGuide from "./CategoryGuide/FeesHeadGuide";

const FeeMasterManager = () => {
  const isDark = useSelector((state) => state.color.mode === "dark");
  const [activeTab, setActiveTab] = useState("FeesCategoryGuide");

  const menuItems = [
    { id: "FeesCategoryGuide", label: "Fees Category Guide", sub: "Setup Groups", icon: LayoutGrid },
    { id: "FeesHeadGuide", label: "Fees Head Guide", sub: "Setup Groups", icon: LayoutGrid },
  ];

  const renderManager = () => {
    switch (activeTab) {
      case "FeesCategoryGuide": return <FeesCategoryGuide />;
      case "FeesHeadGuide": return <FeesHeadGuide />;
      default: return <FeesCategoryGuide />;
    }
  };
